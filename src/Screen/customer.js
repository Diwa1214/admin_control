...
function Customer() {
  ...
  useEffect(() => {
    DataServices.customer().then(data => {
      if (data.data) {
        setState({
          ...state,
          customer: data.data,
  ...
  return (
    ...
    >
      {state.customer && state.customer.length > 0 ? (
        <>
            ...
            <Table className={classes.table} aria-label="simple table">
              <TableHead>
                <TableRow>
                  ...
                  {user ? user.role =="1" || user.role == "2" ?<TableCell align="right">action</TableCell>:null:null}
                </TableRow>
              </TableHead>
              <TableBody>
                    ...
                    <>
                      <TableRow key={item._id}>
                        ...
                        <TableCell align="right">
                         ...
                         {user ?user.role == "1" || user.role == "2" ?<TableCell align="right">
                          <IconButton
                            onClick={() => {
        ...
        <h5 style={{ textAlign: "center" }}>No Customer </h5>
      )}
      <Dialog
        open={open}
        onClose={() => {
